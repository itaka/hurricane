...
AccountDB* account_db_sql(void)
{
	...
	safestrncpy(db->global_db_username, "admin", sizeof(db->global_db_username));
	safestrncpy(db->global_db_password, "adminadmin", sizeof(db->global_db_password));
	safestrncpy(db->global_db_database, "eathena", sizeof(db->global_db_database));
